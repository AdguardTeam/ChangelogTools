...
#
# WARNING: This script wipes the entire workspace. It must only run in a
# disposable Bamboo CI agent workspace.
...
# CI guard — prevent accidental execution outside Bamboo.
